      ...
      <div className="left-panel-container">
        ...
        <Link
          className={`owner-folder ${
            currentString === ownerString ? "selected" : "unselected"
          }`}
          to={`/tickets/search?${ownerString}`}
        >
          Owner
        </Link>
        <Link
          className={`subscribed-folder ${
            currentString === subscribedString ? "selected" : "unselected"
          }`}
          to={`/tickets/search?${subscribedString}`}
        >
          Subscribed
        </Link>
        <Link
          className={`${
            currentString === creatorString ? "selected" : "unselected"
          }`}
          to={`/tickets/search?${creatorString}`}
        >
          Creator
        </Link>
        <Link
          className={`starred-folder ${
            currentString === starredPath ? "selected" : "unselected"
          }`}
          to={`${starredPath}`}
        >
          Starred
        ...
        {folders.map((folder) => (
          <Link
            className={`${
              currentString === folder.queryString ? "selected" : "unselected"
            } custom-folder`}
...
const msp = (state) => {
  ...
  let folders = Object.values(state.folders).filter(
    (folder) => folder.creator == userId
  );
  return {
    userId: userId,
    folders: folders,
