          ...
          <form className="form">
            ...
            <div className="session-form-fields">
              ...
              <input
                ...
                placeholder={
                  this.props.errors.email ? this.props.errors.email : "Email"
                }
              />
              ...
              <div className="session-buttons-container">
                <button
                  className="btn1 session-button"
                  onClick={this.handleSubmit}
                >
                  Log In
                </button>
                <button
                  className="btn1 random session-button"
              ...
              <Link
                to="/signup"
                className="switch-session-form-link session-form-instructions"
              >
                Sign Up
              </Link>
            </div>
