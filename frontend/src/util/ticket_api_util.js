...
export const createTicket = (ticket) => axios.post(`/api/tickets`, ticket);

export const getTicket = (id) => axios.get(`/api/tickets/${id}`);

export const updateTicket = (ticket) =>
  axios.patch(`/api/tickets/${ticket._id}`, ticket);

export const fetchOwnerTickets = (userId) => {
  return axios.get(`/api/tickets/owner/${userId}`);
};
...
export const getTicketsByQueryString = (queryString) => {
  return axios.get(`/api/tickets/search?${queryString}`);
};
